                       ...
                       <?php  foreach ($lcontratocredito as $contCredito): ?>
                          ...
                          ?>
                            <tr id="<?php echo $contCredito->id_Ccr; ?>">
                                        ...
                                        <?php endif ?>
                                        <td><button type="button" class="btn btn-primary" onclick="imprimirContCredito('<?php echo $contCredito->id_Ccr; ?>');">Ver</button></td>
                                        <td><button type="button" class="btn btn-primary" onclick="imprCronograma('<?php echo $contCredito->id_Ccr; ?>');">Cronog.</button></td>
