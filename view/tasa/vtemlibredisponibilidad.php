...
<html  lang="es">
  <head>
    <meta charset="UTF-8">
    <title>Pagina | TEA AHORRO - LD</title>
      ...
      <div class="content-wrapper">
        <!-- Content Header (Page header) -->
         <section class="content-header">
            <h1>
              Tasa Efectiva Anual de Ahorro - Libre Disponibilidad (TEA - LD)
        ...
        <!-- Main content -->
          <section class="content">
            <div class="box box-default">
                <div class="box-body">
                 <button type="button" class="btn btn-primary" id="btntea" name="btntea">Nueva Taza</button>
                </div><!-- /.box-body -->
              </div>
...
<div class="modal fade" id="modalTea" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title"> <i class="fa fa-bank "></i><b></b> TEA - LD</h4>
                    </div>
                    ...
                    <form  action="" method="post"  id="frmtea">
                      <div class="modal-body">
                         <div class="form-group">
                          ...
                          <div class="form-group">
                             <label>Valor:</label>
                              <input class="form-control" placeholder="Valor de TEA - LD ..." type="text"  onkeypress="return soloNumeroDecimales(event,this)"  id="valorTea" name="valorTea" maxlength="50">
                          </div>
    ...
    <script src="view/scripts/tealibredisponibilidad.js"></script>
