      ...
      <div class="content-wrapper">
        <!-- Content Header (Page header) -->
         <section class="content-header">
            <h1>
              ITF
              <small>Mantenimiento de ITF</small>
            </h1>
            <ol class="breadcrumb">
        ...
        <!-- Main content -->
          <section class="content">
            <div class="box box-default">
                <div class="box-body">
                 <button type="button" class="btn btn-primary" id="btnItf" name="btnItf">Insertar ITF</button>
                </div><!-- /.box-body -->
              </div>
                <div id="listaitf"></div>
          </section><!-- /.content -->
...
<div class="modal fade" id="modalItf" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="false">&times;</button>
                        <h4 class="modal-title"> <i class="fa fa-bank "></i>ITF</h4>
                    </div>
                    ...
                    <form  action="" method="post"  id="frmtea">
                      <div class="modal-body">
                         ...
                         <div class="form-group">
                             ...
                             <label>Año:</label>
                              <input class="form-control"  type="text" disabled="" id="anioItf" name="anioItf" value="<?php echo date('Y')?>">
                          </div>

                          <div class="form-group">
                            
                             <label>Valor:</label>
                              <input class="form-control" placeholder="Valor de Itf ..." type="text"  onkeypress="return soloNumeroDecimales(event,this)"  id="valorItf" name="valorItf" maxlength="5">
                          </div>
                            <input type="hidden" id="codigoItf">

                        <div class="modal-footer clearfix">
                            <button type="button" class="btn btn-primary" id="btnguardarItf">Guardar</button>
    ...
    <script src="view/scripts/itf.js"></script>
