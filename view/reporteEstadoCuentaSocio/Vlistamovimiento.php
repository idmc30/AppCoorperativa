                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
                     <tr>
                        ...
                        <th><center>Fecha de Movimiento</center></th>
                       ...
                       <?php  foreach ($lmovimiento as $movimiento): ?>
                            <tr id="<?php echo $movimiento->id_Mov; ?>">
                                        <td> <?php echo "<b>".$c."</b>";?></td>
                                         ...
                                         <?php endif ?>                                    
                                        <td> <center><?php echo number_format(($movimiento->monto_Mov), 2, '.', ','); ?></center></td>
                                        <td> <center><?php echo $movimiento->fecha_Mov; ?></center></td>
                                        <td> <center><?php echo $movimiento->usuario; ?></center></td>   
                                        ...
                                        <td><center><span class="label label-success">Normal</span></center></td>
                                        <?php else: ?>
                                         <td><center><span class="label label-danger">Extorno</span></center></td>
                                        <?php endif ?>        
