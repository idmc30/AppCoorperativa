...
function listarContCredito(idSocio){
 ...
 $.post("index.php?page=pagossocio&accion=listarContCreditos",{codSoc:idSocio}, function (response){
...
function listarCuotas(idContCredito){
    $.post("index.php?page=pagossocio&accion=listaCuotaxContCredito",{codContCredito:idContCredito}, function (response){
...
function pagarCuota(codCuota){
  ...
  $.post("index.php?page=pagossocio&accion=obtenerDetalleCuota",{idCuota:codCuota}, function (response){
...
$("#btnguardarpago").click(function (){
  ...
  var estado="C";
      bootbox.confirm("Esta seguro que desea guardar el pago?", function(result) {
                                  if (result) {
                                      if (efectivo!="") {                                           
                                           $.post("index.php?page=pagossocio&accion=guardarPago",{Pagmonto:monto,Cuoid:cuota,Usuid:idusuario}, function (response){
                                                 //toastr.success(response);
                                                 $.post("index.php?page=pagossocio&accion=estadoPagoCuota",{idCuota:cuota},function (respuesta){
...
function imprimirCuota(idCuota){
     var cuota=$("#txtidcuota").val();
     window.open("index.php?page=pagossocio&accion=imprimirTicketPago&cod="+idCuota, '_blank'); 
