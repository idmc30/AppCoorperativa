...
<html  lang="es">
  <head>
    <meta charset="UTF-8">
    <title>Pagina | Reporte Socios</title>
  ...
  <body class="skin-blue sidebar-mini">
      ...
      <div class="content-wrapper">
        <!-- Content Header (Page header) -->
         <section class="content-header">
            <h1>
              Reporte de Socios
              <small>Reportes de Socios inscritos por Rango de Fecha</small>
            </h1>
            <ol class="breadcrumb">
    ...
    <script src="view/scripts/bootbox.js"></script>
     ...
     <script src="view/dist/js/bootstrap-datepicker.js"></script>
      <script src="view/scripts/reportesociocont.js"></script>
