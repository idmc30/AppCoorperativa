      ...
      <div class="content-wrapper">
        <!-- Content Header (Page header) -->
         <section class="content-header">
            <h1>
              Reporte de Contratos por socio
              <small>Listados de Contrato de credito y ahorro por Socios</small>
            </h1>
            <ol class="breadcrumb">
          ...
          <section class="content">
            <div class="col-xs-3">
                ...
                <button type="button" class="btn btn-primary"  id="impcontSoc" name="impcontSoc">Imprimir</button>   
            </div>

                   <div class="row">
                        <div id="listarContratrosxSoc"> 
                        </div>
                   </div><!-- /.row -->
...
<!-- jQuery 2.1.4 -->
    ...
    <script src="view/scripts/reporteContSoc.js"></script>
