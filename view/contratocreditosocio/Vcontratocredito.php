                              ...
                              <div class="box-header with-border">
                                ...
                                <div class="form-group">
                                 ...
                                 <br> <br>
                                   <div class="form-group">
                                     <label class="col-sm-6 control-label" style="width:20%";>
                                      <b><b>Seguro desgravamen individual mensual:</b></b>
                                      </label>
                                       <div class="input-group">
                                     <div class="col-sm-6">
                                      <div class="input-group">
                                          ...
                                          <div class="input-group">
                                              <div class="input-group-addon">
                                               ...
                                               <?php  foreach ($litf as $ITF): ?>
                                                <!--<input id="itf" value="0.005" disabled="" class="form-control" type="text">-->
                                                   <input type="text" value="<?php echo $ITF->valor_tas; ?>" id="itf" name="itf" class="form-control" disabled="";>
