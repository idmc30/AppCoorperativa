      ...
      <div class="content-wrapper">
        <!-- Content Header (Page header) -->
         <section class="content-header">
            <h1>
              Cargos
              <small>Mantenimiento de Cargos</small>
            </h1>
            <ol class="breadcrumb">
        ...
        <!-- Main content -->
          <section class="content">
            <div class="box box-default">
                <div class="box-body">
                 <button type="button" class="btn btn-primary" id="modal" name="modal">Insertar Cargos</button>
                </div><!-- /.box-body -->
              </div>
                <div class="box box-default" id="listacargo"></div>
          </section><!-- /.content -->
...
<div class="modal fade" id="observaciones" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title"><i class="fa  fa-comment-o"></i>Nuevo Cargo</h4>
                    </div>
                      ...
                      <div class="modal-body">
                          <div class="form-group">
                             ...
                             <label>Nombre de Cargo:</label>
                              <input class="form-control" placeholder="Cargo ..." type="text" id="nomcargo" name="nomcargo" maxlength=50>
                          </div>
    ...
    <script src="view/scripts/cargos.js"></script>
