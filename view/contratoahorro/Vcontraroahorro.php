      ...
      <div class="content-wrapper">
        <!-- Content Header (Page header) -->
         <section class="content-header">
            <h1>
              Contrato de Ahorro
              <small>Mantenimiento de Contrato de Ahorro</small>
            </h1>
            <ol class="breadcrumb">
...
<div id="modalcontAhorro" class="modal fade" role="dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
                      <label>TEA:</label>
                      <input class="form-control" placeholder="Tasa Efectiva Anual ..." type="text" id="texttem" name="texttem" maxlength="15" disabled="">
         </div>
         <div class="form-group">
          <label>Socios:</label>              
  ...
  <!-- jQuery 2.1.4 -->
   <script src="view/plugins/jQuery/jQuery-2.1.4.min.js"></script>
    ...
    <script src="view/scripts/contratoahorro.js"></script>
