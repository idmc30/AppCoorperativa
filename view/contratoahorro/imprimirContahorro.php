...
//for($i=1;$i<=85;$i++)
    ...
    $pdf->Ln(8);
    $pdf->Cell(0,10, utf8_decode("N° de cuenta: ".$response["nroAhorroCah"]." Fecha de apertura: ".$response["fechaInicioCah"] ."Monto de depósito: ".$response["montoDepositadoCah"]." SOLES"));
    $pdf->Ln(8);
