                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                        <th>N°</th>
                        <th>N° Contrato de Ahorro</th>                       
                        <th>Fecha Inicio</th>
                        <th>Fecha de Fin</th>
                        <th><center>Monto de Apertura</center></th>
                        <th><center>Interes Ganado</center></th> 
                        <th>Monto Actual</th>                        
                        <th>Tipo</th>
                        <th>estado</th>
                        <th>Socio</th>
                      ...
                      <?php $c=1; ?>
                         <?php  foreach ($lcontahorro as $contahorro): ?>
                             <tr id="<?php echo $contahorro->id_Cah; ?>">
                                        ...
                                        <td> <?php echo $contahorro->fechaInicio_Cah; ?></td>
                                        <td> <?php echo $contahorro->fechaFin_Cah; ?></td>
                                        <td><center><?php echo number_format(($contahorro->montoDepositado_Cah), 2, '.', ','); ?></center></td>
                                        <td><center> <?php echo number_format(($contahorro->interesGanado_Cah), 2, '.', ','); ?></center></td>
                                        <td> <?php echo number_format(($contahorro->montoActual_Cah), 2, '.', ','); ?></td>                                        
