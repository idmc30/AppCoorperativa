      ...
      <div class="content-wrapper">
        <!-- Content Header (Page header) -->
         <section class="content-header">
            <h1>
              Zonas
              <small>Mantenimiento de Zonas</small>
            </h1>
            <ol class="breadcrumb">
        ...
        <!-- Main content -->
          <section class="content">
            <div class="box box-default">
                <div class="box-body">
                 <button type="button" class="btn btn-primary" id="modal" name="modal">Insertar Zonas</button>
                </div><!-- /.box-body -->
              </div>
                <div id="listarzona"></div>
          </section><!-- /.content -->
                 
         </div><!-- /.content-wrapper -->
 
<div class="modal fade" id="modalZona" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="false">&times;</button>
                        <h4 class="modal-title"><i class="fa  fa-comment-o"></i>Nueva Zona</h4>
                    </div>
                      ...
                      <div class="modal-body">
                          <div class="form-group">
                             ...
                             <label>Nombre de la Zona:</label>
                              <input class="form-control" placeholder="Zona ..." type="text" id="nombreZona" name="nombreZona" maxlength=50/>

                              <label>Descripción de la Zona:</label>
                              
                              <textarea class="form-control" rows="3" placeholder="Descripción ..."  id="descripcionZona" name="descripcionZona" maxlength=50></textarea>
                              
                          </div>
                            <input type="hidden" id="codigoZona">

                        <div class="modal-footer clearfix">
                            <button type="button" class="btn btn-primary" id="btnguardarzona">Guardar</button>
    ...
    <script src="view/scripts/zonas.js"></script>
