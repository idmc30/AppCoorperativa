...
<html  lang="es">
  <head>
    <meta charset="UTF-8">
    <title>Pagina | Reporte Deduda por Fecha</title>
  ...
  <body class="skin-blue sidebar-mini">
      ...
      <div class="content-wrapper">
        <!-- Content Header (Page header) -->
         <section class="content-header">
            <h1>
              Reporte de Deudas de Contrato de Credito por fecha
              <small>Lista de cuotas vencidas por rango de fecha</small>
            </h1>
            <ol class="breadcrumb">
    ...
    <script src="view/scripts/reporteDeudaxFecha.js"></script>
