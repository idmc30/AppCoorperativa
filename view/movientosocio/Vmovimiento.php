          ...
          <section class="content">
              <div class="col-xs-4">
                <select class="form-control" id="cmbtipoContrato"  name="cmbtipoContrato">
                 <option style="display:none;" value="0"  selected>Seleccione Tipo de Contrato</option>                                               
            ...
            <div class="col-xs-4">
                ...
                <div class="col-md-3 col-sm-11 col-xs-11" id="informacion" name="informacion">
              </div>
              <br/>
           <div class="row">
...
<div class="modal fade" id="modamovimiento" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form  action="" method="post">
                    ...
                    <div class="form-group">
                      <label>Monto</label>
                      <input type="hidden" id="textmonto" name="textmonto" >
                    </div>                                                                         
         </form>  
      ...
      <div class="modal-footer">
        <input type="text" id="texttipomovimiento" name="texttipomovimiento">
    ...
    <script src="view/scripts/movimientosocio.js"></script>
