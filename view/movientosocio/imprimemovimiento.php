...
$pdf->Ln(3);
     ...
     if ($response["tipoMov"]=="D") {
         ...
         $pdf->SetFont('Arial','',7);
          ...
          $w = array(15,12,22,15);
          $pdf->SetFont('Arial','b',7);
          $pdf->Cell(0,1,"M O N T O     I N I C I A L",0,'','C');
          $pdf->SetFont('Arial','',7);
          $pdf->Ln(2);
          $pdf->Cell(0, 1, "____________________________________________", 0,'','C');
          $pdf->Ln(3);
         ...
         $MONTOINICIAL=$response["montoActualCah"]+0;
          $pdf->Ln(3);
          $pdf->SetFont('Arial','B',7);$pdf->Cell(0,1,'MONTO ABONADO :                                '.$response["montoMov"],'');
          $pdf->Ln(4);
          $pdf->SetFont('Arial','b',7);$pdf->Cell(0, 1, "____________________________________________", 0,'','C');
          $pdf->Ln(6);
          $pdf->SetFont('Arial','b',7);$pdf->Cell(0,1,'SALDO DISPONIBLE              Total  S/.  '.$response["montoMov"],'');
          $pdf->Ln(4);
          $pdf->SetFont('Arial','b',7);$pdf->Cell(0, 1, "____________________________________________", 0,'','C');
